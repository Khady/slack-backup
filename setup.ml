...
(* OASIS_START *)
(* DO NOT EDIT (digest: c760e51884f46cc7e79e020f0b6729a8) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights = [];
          maintainers = ["Louis Roch\195\169 <louis@louisroche.net>"];
          authors = ["Louis Roch\195\169 <louis@louisroche.net>"];
          homepage = Some "https://github.com/Khady/slack-backup";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "slack_backup_lib";
                   ...
                   {exec_custom = false; exec_main_is = "slack_backup.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\\:Zv\127\228\208\180F\221\160\026\248\127?l";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
